...
class Agent:
    def __init__(self, name, food_preference,cuisine,trans_mat):
        self.name = name
...
def create_agents(vegan,vegt,omni):
    ...
    for i in range(vegan):
        ...
        agents.append(Agent("user-" + str(i + 1),"vegan",test,[[(1 - cui_no_match), cui_no_match], [(1 - cui_match), cui_match]]))
    ...
    for k in range(vegt):
        ...
        agents.append(Agent("user-" + str(k + 1 + vegan),"vegetarian",test,[[[(1-cui_no_match_vegan), cui_no_match_vegan], [(1-cui_vegan_match), cui_vegan_match]],[[(1 - cui_no_match),cui_no_match],[(1 - cui_match), cui_match]]]))
    ...
    for l in range(omni):
        ...
        agents.append(Agent("user-" + str(l + 1 + vegan + vegt),"omnivore",test,[[[(1-cui_no_match_vegan), cui_no_match_vegan], [(1-cui_vegan_match), cui_vegan_match]], [[(1-cui_no_match_vegt),cui_no_match_vegt],[(1-cui_vegt_match),cui_vegt_match]], [[(1-cui_no_match),cui_no_match],[(1-cui_match),cui_match]]]))
